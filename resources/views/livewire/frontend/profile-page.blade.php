    ...
    <div class="w-full flex flex-col justify-start items-start">
        ...
        <div class="w-full bg-white">
            <ul class="divide-y divide-gray-200">
                ...
                <li>
                    <a href="{{ route('frontend.page-static', ['slug' => $ps->slug]) }}" class="flex items-center px-4 py-4 hover:bg-purple-100 transition-colors">
                ...
                <li>
                    <a href="{{ route('my-setting') }}" class="flex items-center px-4 py-4 hover:bg-purple-100 transition-colors">
                        <svg class="w-6 h-6 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
