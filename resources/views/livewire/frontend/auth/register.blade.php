...
<div class="max-w-md mx-auto mt-10 bg-white shadow rounded p-6">
    <div class="w-full flex justify-start items-center"><span role="img" aria-label="arrow-left" tabindex="-1" class="anticon anticon-arrow-left h-6 w-6"><svg viewBox="64 64 896 896" focusable="false" data-icon="arrow-left" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M872 474H286.9l350.2-304c5.6-4.9 2.2-14-5.2-14h-88.5c-3.9 0-7.6 1.4-10.5 3.9L155 487.8a31.96 31.96 0 000 48.3L535.1 866c1.5 1.3 3.3 2 5.2 2h91.5c7.4 0 10.8-9.2 5.2-14L286.9 550H872c4.4 0 8-3.6 8-8v-60c0-4.4-3.6-8-8-8z"></path></svg></span></div>
    ...
    <form id="registerForm" class="space-y-4">
        ...
        <div class="flex space-x-2">
            <button type="button" id="sendOtpBtn" class="flex-1 bg-[#fef4bf] text-black font-bold py-2 px-4 rounded">
                Gửi OTP
            </button>
            <button type="button" id="verifyOtpBtn" class="flex-1 bg-green-600 text-white py-2 px-4 rounded hidden">
                Xác thực OTP
            </button>
        </div>
        ...
        <div id="otpContainer" class="hidden">
            ...
            <input type="text" id="otpCode" class="w-full border rounded px-3 py-2"
