                ...
                <div class="bg-white p-4 shadow rounded-lg mb-3">
                    <div class="grid grid-cols-3 gap-1">
                        <div class="col-span-1">
                            <label class="text-sm font-medium text-gray-700 block">Kỳ số:</label>
                            <span class="text-sm text-gray-600">{{ $log->installment_no }}</span>
                        </div>
                        <div class="col-span-1">
                            <label class="text-sm font-medium text-gray-700">Tiền phải trả:</label>
                            @php
                            ...
                            @endphp
                            <span class="text-sm text-gray-600">{{ number_format($totalClientDue, 0, ',', '.') }} VND</span>
                        </div>
                        <div class="col-span-1">
                            <label class="text-sm font-medium text-gray-700 block">Đóng trước ngày:</label>
                            <span class="text-sm text-gray-500">{{ optional($log->due_date)->format('d/m/Y') }}</span>
                        </div>
                    </div>
                </div>
            @empty
