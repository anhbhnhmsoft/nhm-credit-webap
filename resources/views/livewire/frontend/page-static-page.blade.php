<div class="w-full h-full">
    <div class="shadow sticky top-0 z-10 py-3 px-4 flex justify-between items-center w-full bg-green-100 border-b border-white">
        <a href="{{ route('profile') }}" class="text-black" aria-label="Quay lại">
        ...
        <span class="text-sm text-black">{{ $page->title }}</span>
